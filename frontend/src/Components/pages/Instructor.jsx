...
// const Instructor = () => {
//   //instructor,course,lecture,date
...
//             const checkResponse = await axios.post(`${process.env.REACT_APP_SERVER_DOMAIN}/api/v1/admin/check-schedule`, { date: scheduleData.date });
//         if (checkResponse.data.exists) {
//           toast('Lecture already set');
//           return;
//         }
            
//             const response=await axios.post(`${process.env.REACT_APP_SERVER_DOMAIN}/api/v1/admin/add-schedule`,{scheduleData})
//             // const response = await axios.post('http://localhost:8000/api/v1/admin/add-schedule', { scheduleData });
...
const Instructor = () => {
  ...
  return (
    <div className="bg-blue-100 min-h-screen flex items-center justify-center">
      <div className="flex flex-col md:flex-row w-full max-w-4xl p-6 bg-white shadow-md rounded-lg space-y-6 md:space-y-0 md:space-x-6">
